...
```
### Clustering without heatmap (new tab 1)
...
```
### Clustering with heatmap (new tab 2)
...
This tab features a tempogram of my first track, which happens to be 80 BPM. Because of this, even in the wrapped tempogram, it shows yellow lines on both 80BPM AND its tempo harmonic 160 BPM.
